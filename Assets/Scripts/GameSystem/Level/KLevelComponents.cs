...
class KLevelComponents : MonoBehaviour
{
	...
	public List<GameObject> dicUnitObjective;
	...
	void Awake()
	{
		...
		{{KEnums.UNIT.BASIC, dicUnitBasic},{KEnums.UNIT.PLAYER, dicUnitPlayer}, {KEnums.UNIT.ENEMY , dicUnitEnemy },{KEnums.UNIT.OBJECTIVE , dicUnitObjective}};
